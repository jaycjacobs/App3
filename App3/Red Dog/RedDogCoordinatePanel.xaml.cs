...
namespace RedDog.Drawing_page
{
    public sealed partial class RedDogCoordinatePanel : UserControl
    {
        RedDogArrowButtonDirection _keyDirection = 0;
        int _keyCount = 0;
        int _keySteps = 1;

        CoordinateMode _coordinateMode = Globals.CoordinateMode;

        Unit _modelUnit = Unit.Millimeters;
        bool _architect = false;

        public RedDogCoordinatePanel()
        {
            this.InitializeComponent();

            _upButton.CoordinatePanel = this;
            _downButton.CoordinatePanel = this;
            _leftButton.CoordinatePanel = this;
            _rightButton.CoordinatePanel = this;

            this.Loaded += RedDogCoordinatePanel_Loaded;
            this.Unloaded += RedDogCoordinatePanel_Unloaded;
            this.PointerPressed += RedDogCoordinatePanel_PointerPressed;
            this.PointerMoved += RedDogCoordinatePanel_PointerMoved;
            this.PointerReleased += RedDogCoordinatePanel_PointerReleased;
            this.PointerEntered += RedDogCoordinatePanel_PointerEntered;
            this.KeyDown += RedDogCoordinatePanel_KeyDown;

            SetCoordinateMode(Globals.CoordinateMode);

            DataContext = Globals.UIDataContext;
        }

        private void RedDogCoordinatePanel_KeyDown(object sender, KeyRoutedEventArgs e)
        {
            switch (e.Key)
            {
                ...
                case (VirtualKey)0xBA:  // semicolon
                    UnFocusCoordinateEntryBox();
                    break;
        ...
        private void UnFocusCoordinateEntryBox()
        {
        ...
        private void RedDogCoordinatePanel_PointerEntered(object sender, PointerRoutedEventArgs e)
        {
        ...
        private void RedDogCoordinatePanel_Loaded(object sender, RoutedEventArgs e)
        {
        ...
        private void RedDogCoordinatePanel_Unloaded(object sender, RoutedEventArgs e)
        {
            Globals.Events.OnCoordinateDisplay -= Events_OnCoordinateDisplay;
            Globals.Events.OnOptionsChanged -= Events_OnOptionsChanged;
            Globals.Events.OnCoordinateEntry -= Events_OnCoordinateEntry;
        ...
        private void RedDogCoordinatePanel_PointerPressed(object sender, PointerRoutedEventArgs e)
        {
        ...
        private void RedDogCoordinatePanel_PointerMoved(object sender, PointerRoutedEventArgs e)
        {
        ...
        private void RedDogCoordinatePanel_PointerReleased(object sender, PointerRoutedEventArgs e)
        {
        ...
        public void Step(RedDogArrowButtonDirection direction)
        {
            ...
            double step = Globals.ActiveDrawing.ModelToPaper(Globals.Input.ShiftKeyIsDown ? .01 : Globals.xSnap);

            if (Globals.Input.GridSnap == false && _keyCount < 10)
            {
            ...
            switch (_keyDirection)
            {
                case RedDogArrowButtonDirection.up:
                    Globals.Input.MoveCursorBy(0.0, -step * _keySteps);
                    break;
                case RedDogArrowButtonDirection.left:
                    Globals.Input.MoveCursorBy(-step * _keySteps, 0.0);
                    break;
        ...
        //public void Step(RedDogArrowButtonDirection direction, bool stillDown)
        //{
        //    if (_keyDirection == direction)
        //    {
        //        _keyCount++;
