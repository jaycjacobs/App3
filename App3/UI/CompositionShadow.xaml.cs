...
namespace CirrosUI.Xaml
{
    ...
    public sealed partial class CompositionShadow : UserControl
    {
        ...
        private void UpdateShadowSize()
        {
            ...
            if (_castingElement != null)
            {
                //System.Diagnostics.Debug.WriteLine($"_castingElement: offset={_castingElement.GetValue(OffsetXProperty)},{_castingElement.GetValue(OffsetYProperty)}");
                //System.Diagnostics.Debug.WriteLine($"_shadowVisual: offset={_shadowVisual.Offset.X},{_shadowVisual.Offset.Y}");
