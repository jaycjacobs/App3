...
namespace CirrosUI
{
    public sealed partial class CopyAlongArcContextMenuPanel : UserControl
    {
        double _dragXOff = 0;
        double _dragYOff = 0;
        ...
        public CopyAlongArcContextMenuPanel()
        {
        ...
        {
            SetCopyRepeatType(Globals.RadialCopyRepeatType);

            _connectCB.IsChecked = Globals.RadialCopyRepeatConnect;
            _endCB.IsChecked = Globals.RadialCopyRepeatAtEnd;

            _spacingBox.Value = Globals.RadialCopyRepeatAngle * Construct.cRadiansToDegrees;
            _repeatBox.Value = Globals.RadialCopyRepeatCount;
        ...
        public void Select(object o)
        {
            ...
            else
            {
                ...
                _getSymbolButton.IsChecked = false;
                _drawArcButton.IsChecked = false;
        ...
        private void SetCopyRepeatType(CopyRepeatType type)
        {
            ...
            Globals.RadialCopyRepeatType = type;
        }
        ...
        private void _drawArcButton_Click(object sender, RoutedEventArgs e)
        {
            Select(_selection);
        }
        ...
        {
            Globals.RadialCopyRepeatConnect = (bool)_connectCB.IsChecked;
        }

        private void _endCB_Checked(object sender, RoutedEventArgs e)
        {
            Globals.RadialCopyRepeatAtEnd = (bool)_endCB.IsChecked;
        }
        ...
        private void _repeatBox_OnValueChanged(object sender, ValueChangedEventArgs e)
        {
            ...
            {
                Globals.RadialCopyRepeatCount = (int)_repeatBox.Value;
            }
            else
            {
                _repeatBox.Value = Globals.RadialCopyRepeatCount;
        ...
        private void _spacingBox_OnValueChanged(object sender, ValueChangedEventArgs e)
        {
            ...
            {
                Globals.RadialCopyRepeatAngle = _spacingBox.Value / Construct.cRadiansToDegrees;
            }
            else
            {
                _spacingBox.Value = Globals.RadialCopyRepeatAngle * Construct.cRadiansToDegrees;
